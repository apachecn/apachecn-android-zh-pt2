...
![Displaying a web page in your application](graphics/B05057_12_1.jpg)
...
小心使用安卓清单，因为每当网络状态发生变化时，它都会通知你的应用程序，即使你的应用程序没有被使用。这会导致不必要的电池消耗。如果您的应用程序只需要在用户实际使用您的应用程序时响应网络变化，请改为在代码中创建监听器。
...
2.  Import the `Volley` module by going to **File** | **New** | **Import Module** (see the following screenshot) and follow the wizard.
    ...
    ![How to do it...](graphics/B05057_12_2.jpg)
