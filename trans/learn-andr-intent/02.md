...
![Role of intents in an Android Application](graphics/9639_02_01.jpg)
...
![Role of intents in e-mail and social network posts](graphics/9639_02_02.jpg)

使用分享意向在各种平台上分享帖子

下一个截图显示了当你给用户一个功能时会发生什么，例如用户想要通过 Gmail 共享它。在这种情况下，屏幕会显示您的内容，如下图所示:

![Role of intents in e-mail and social network posts](graphics/9639_02_02_01.jpg)
...
![Role of intent in Status Bar](graphics/9639_02_03.jpg)
...
![Implementation of Android Intents for Activity Navigation](graphics/9639_02_04.jpg)
...
6.  After coming back to first activity it will show the toast in order to communicate the result from the destination activity.
    ...
    ![Going deep into the example](graphics/9639_02_05.jpg)
