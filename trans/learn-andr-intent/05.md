...
![Taking a simple example](graphics/9639_05_01.jpg)

在列表视图中列出新闻的阅读器应用程序的活动。
...
![Taking a simple example](graphics/9639_05_02.jpg)
...
2.  Run the project and the following screenshot will appear on the screen:
    ...
    ![Implement a readymade tutorial](graphics/9639_05_13.jpg)
...
3.  Fill the `EditText` fields and tap the button to transfer the data. The `Activity2` screen will appear with the form data that was entered in the `Activity1` screen:
    ...
    ![Implement a readymade tutorial](graphics/9639_05_14.jpg)
...
![Extras supported data types](graphics/9639_05_03.jpg)
...
![The concept of Android Bundles](graphics/9639OS_05_06.jpg)
...
![The concept of Android Bundles](graphics/9639_05_04.jpg)
...
![Implement a readymade tutorial](graphics/9639_05_05.jpg)

活动 1 有三个编辑文本字段，用于接收用户的输入，还有一个按钮，用于将数据传输到下一个活动

当您在第一个屏幕上时，输入数据并按下按钮迁移到显示输入数据的下一个活动。屏幕将如下所示:

![Implement a readymade tutorial](graphics/9639_05_06.jpg)
...
![An example of Serializable](graphics/9639OS_05_10.jpg)
...
![An example of Serializable](graphics/9639OS_05_11.jpg)
...
![Passing Serializable – a tutorial](graphics/9639_05_07.jpg)

要求输入数据以通过 serializable 发送数据的源活动

一按下**输入数据**按钮，`Activity2.java`就会打开，并显示如下画面:

![Passing Serializable – a tutorial](graphics/9639_05_08.jpg)

练习 2 显示数据已成功输入

同时，当你看到这个项目的日志文件时，它会显示我们在`Activity2.java`文件中记录的数据。请看下面的截图:

![Passing Serializable – a tutorial](graphics/9639_05_09.jpg)
...
![Viewing a map](graphics/9639OS_05_15.jpg)
...
![Viewing a map](graphics/9639_05_10.jpg)
...
![Sending an e-mail](graphics/9639OS_05_19.jpg)
...
![Sending an e-mail](graphics/9639_05_12.jpg)
...
![Making a call](graphics/9639OS_05_21.jpg)
