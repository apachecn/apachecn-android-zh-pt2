...
![How it works…](graphics/8987OS_02_01.jpg)
...
![How it works…](graphics/8987OS_02_03.jpg)
...
![How it works…](graphics/978-1-849518-98-7_02_04.jpg)
...
![Applying primitives to a layer](graphics/978-1-849518-98-7_02_05.jpg)
...
![How it works…](graphics/978-1-849518-98-7_02_06.jpg)
...
![There's more...](graphics/978-1-849518-98-7_02_08.jpg)
...
![There's more...](graphics/978-1-849518-98-7_02_09.jpg)
...
![Using OpenGL's dithering capability](graphics/978-1-849518-98-7_02_07.jpg)
...
![Using relative rotation](graphics/978-1-849518-98-7_02_02.jpg)
...
覆盖`Entity`对象的`onManagedUpdate()`方法在所有类型的情况下都非常有用。通过这样做，我们可以允许我们的实体在每次通过更新线程更新实体时执行代码，每秒发生多次，除非实体被设置为忽略更新。有很多可能性，包括动画我们的实体，检查碰撞，产生定时事件，等等。使用我们的`Entity`对象的`onManagedUpdate()`方法也使我们不必为单个实体的基于时间的事件创建和注册新的计时器处理程序。
