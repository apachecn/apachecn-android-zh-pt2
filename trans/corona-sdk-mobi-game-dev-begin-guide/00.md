...
[第三章](03.html "Chapter 3. Building Our First Game – Breakout")*打造我们的第一场比赛——突围*，讨论打造你的第一场比赛——突围的前半部分。您将学习如何在Corona项目中构建游戏文件，并创建将显示在屏幕上的游戏对象。
...
[第 6 章](06.html "Chapter 6. Playing Sounds and Music")、*播放声音和音乐*，提供了如何将音效和音乐应用到应用的信息。包含某种类型的音频以增强游戏开发的感官体验是至关重要的。您将学习如何通过加载、执行和循环技术与Corona音频系统结合音频。
...
您将需要以下项目，然后才能开始使用Corona软件开发工具包开发游戏:
...
最后，你需要最新的稳定版本的Corona软件开发工具包。这适用于所有订阅级别。
