...
[第 6 章](06.html "Chapter 6. Playing Sounds and Music")、*播放声音和音乐*，提供了如何将音效和音乐应用到应用的信息。包含某种类型的音频以增强游戏开发的感官体验是至关重要的。您将学习如何通过加载、执行和循环技术与电晕音频系统结合音频。
...
您将需要以下项目，然后才能开始使用科罗纳软件开发工具包开发游戏:
