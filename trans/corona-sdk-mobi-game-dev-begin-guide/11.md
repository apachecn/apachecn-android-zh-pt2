...
商店模块已经合并到 Corona API 中，类似于脸书和游戏网络。你可以在[上找到更多关于Corona商店模块的信息。](http://docs.coronalabs.com/daily/guide/monetization/IAP/index.html)
...
1.  在Corona模拟器中，创建一个分线应用内购买演示的分发版本。编译好构建后，在您的 iOS 设备上上传构建。
...
经过 11 章，我们已经到了这本书的结尾。您现在已经获得了足够的知识来创建自己的应用，以便在苹果应用商店或谷歌 Play 商店销售。希望你获得的所有信息都有帮助。我期待听到关于你使用Corona SDK 开发的游戏！