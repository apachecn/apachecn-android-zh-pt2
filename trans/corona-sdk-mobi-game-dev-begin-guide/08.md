...
Composer API 为开发人员提供了一个简单的解决方案来控制有无过渡的场景。这是一个很棒的场景管理库，可以显示菜单系统，甚至管理游戏中的多个关卡。Composer 还附带了各种过渡效果。更多信息可以在[http://docs.coronalabs.com/api/library/composer/index.html](http://docs.coronalabs.com/api/library/composer/index.html)的Corona文档中找到。
