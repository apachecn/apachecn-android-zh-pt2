...
![Time for action – dragging the paddle in the simulator](graphics/9343OT_04_01.jpg)
...
![Time for action – removing the bricks](graphics/9343OT_04_02.jpg)
...
3.  Add in the ball movement for the *x* direction:
    ...
    ![Time for action – updating the ball](graphics/9343OT_04_03.jpg)
...
4.  Add in the ball movement for the *y* direction:
    ...
    ![Time for action – updating the ball](graphics/9343OT_04_04.jpg)
...
5.  Add in the ball movement when it collides with the bottom of the game play screen. Create the lost alert screen and a game event for `"lose"`. Close the function with `end`:
    ...
    ![Time for action – updating the ball](graphics/9343OT_04_05.jpg)
