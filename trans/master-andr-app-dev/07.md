...
![The traditional way of downloading images](graphics/4887_07_01.jpg)
...
![Introducing Picasso](graphics/4887_07_02.jpg)
...
![Vector drawables](graphics/4887_07_03.jpg)
...
![Working with the nine patch](graphics/4887_07_04.jpg)
...
![Working with the nine patch](graphics/4887_07_05.jpg)

安卓提供了一个工具来创建这九个补丁图像，你可以在 `tools`下的你的 SDK 文件夹中找到它们。只需打开`draw9patch`并拖动一个图像到其中。

![Working with the nine patch](graphics/4887_07_06.jpg)
...
![Detecting and locating leaks](graphics/4887_07_07.jpg)
...
![Detecting and locating leaks](graphics/4887_07_08.jpg)

选择你的应用程序进程，点击**更新堆**:

![Detecting and locating leaks](graphics/4887_07_09.jpg)

一旦选择了这个，我们就可以看到对象的分配；在位图或线程泄漏的情况下，这将是一个很好的线索:

![Detecting and locating leaks](graphics/4887_07_10.jpg)
...
![Detecting and locating leaks](graphics/4887_07_11.jpg)
...
![Using WeakReference](graphics/4887_07_12.jpg)
