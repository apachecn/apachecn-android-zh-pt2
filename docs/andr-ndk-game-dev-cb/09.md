...
要更好的感受游戏逻辑，可以搭建运行`2_PuzzleProto`项目，可以从[www.packtpub.com/support](http://www.packtpub.com/support)下载。如果你想享受全功能游戏，就去从GooglePlay下载我们的林道拼图高清版。你可以在[http://play.google.com/store/apps/details?做 id = com . linder daum . engine . puzzlhd](http://play.google.com/store/apps/details?id=com.linderdaum.engine.puzzLHD)。
