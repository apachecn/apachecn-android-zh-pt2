...
![Structure of the Contacts content provider](graphics/Image1.jpg)
...
![Modifying Contacts](graphics/8123OS_05_01.jpg)
...
![Modifying Contacts](graphics/8123OS_05_02.jpg)

这里我们看到，我们已经成功地为联系人 Vicky 插入了一个工作号码，然后又为 Daniel 插入了一个工作号码，我们看到如下:

![Modifying Contacts](graphics/8123OS_05_03.jpg)
