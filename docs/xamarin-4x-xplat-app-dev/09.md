...
![Setting up your Azure account](../Images/image00250.jpeg)
...
您可以看到为什么使用 Azure Functions 是简单移动应用程序的好选择。加速开发的好处及其提供的许多特性非常适合我们的 XamSnap 示例应用程序。
...
![Exploring Azure Functions](../Images/image00251.jpeg)
...
我们定义了一些使用语句和一些变量，我们将在整个课程中使用它们。确保您为您的 Azure 功能应用程序填写了正确的网址。
...
![Setting up your provision profile](../Images/image00252.jpeg)

对于推送通知，我们必须使用带有明确应用程序标识的配置文件，该标识不是开发证书。现在让我们设置一个配置文件:
...
![Setting up your provision profile](../Images/image00253.jpeg)
...
![Setting up a certificate for push notifications](../Images/image00254.jpeg)
...
![Sending push notifications from the server-side](../Images/image00255.jpeg)
...
![Implementing Google Cloud Messaging](../Images/image00256.jpeg)
...
![Implementing Google Cloud Messaging](../Images/image00257.jpeg)
